class RemindersController < ApplicationController
  ...
  def create
    @reminder = current_user.reminders.new(reminder_params.except(:relationship_profile_id, :important_date_id, :scheduled_at, :time_zone))
  ...
  def update
    saved = @reminder.with_lock do
      @reminder.assign_attributes(reminder_params.except(:relationship_profile_id, :important_date_id, :scheduled_at, :time_zone))
      assign_relationship_context(@reminder)
      assign_schedule(@reminder)
      @reminder.save
    end
