...
claim: >
  ...
  anniversary, and milestone planning links hand off to a prefilled EventPlan
  for the owned date; other date types target suggestions rendered in the
...
links hand birthdays, anniversaries, and milestones to the owner-scoped
EventPlan workflow and otherwise stay on the profile when the matching planning
suggestion anchor is rendered.
