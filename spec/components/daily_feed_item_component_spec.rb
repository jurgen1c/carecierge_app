...
RSpec.describe DailyFeedItemComponent, type: :component do
  it "renders source context and accessible source and feed actions" do
    ...
    expect(page).to have_text("Why this is here")
    ...
    expect(page).to have_css("h3.feed-title", text: "Call Taylor")
    expect(page).to have_css("details.feed-source p", text: "Share the introduction.")
